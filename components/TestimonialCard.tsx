...
export default function TestimonialCard({
    ...
    const renderHighlightedText = (text: string) => {
        ...
        return parts.map((part, index) => {
            const shouldHighlight = highlightWords.some((word) => word.toLowerCase() === part.toLowerCase());
    ...
    return (
        <div className="relative flex justify-center items-center overflow-hidden rounded-3xl bg-[#14285A] shadow-2xl mx-auto w-full max-w-[1070px] min-h-[300px] md:min-h-[409px]">
