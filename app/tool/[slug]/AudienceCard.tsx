...
export default function AudienceCard({
    ...
    return (
        <div className="bg-white rounded-xl overflow-visible shadow-sm border border-gray-200 relative h-fit">
            ...
            <div className="pt-[63px] p-5 relative z-0 min-h-[300px] flex flex-col">
                <h3 className="text-base font-semibold text-center mb-4" style={{ color: '#1466F6' }}>
                    {title}
                </h3>
                            ...
                            {visibleBullets.map((bullet, idx) => (
                                <li key={idx} className="flex flex-col">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <span className="font-medium text-gray-900 break-words min-w-0 flex-1">
                                            {bullet.title}
                                        </span>
                                    </div>
